...
051. [pass] tools=worldClock.set_zones,dialClock.set_night_mode; command=世界时钟显示北京伦敦纽约
...
058. [pass] tools=widget.remove,dialClock.set_night_mode; command=关闭时钟夜间模式
059. [pass] tools=messageBoard.send; command=留言板发一句我在测试
060. [pass] tools=music.play; command=搜一点轻松的音乐
...
070. [pass] tools=widget.fullscreen_focus,tv.fullscreen; command=电视全屏
...
077. [pass] tools=widget.remove,recorder.start; command=把录音机收起来
078. [pass] tools=widget.remove,weather.set_city; command=把天气收起来
079. [pass] tools=widget.remove,countdown.set; command=把倒计时收起来
080. [pass] tools=widget.remove,todo.add_item; command=把待办收起来
081. [pass] tools=widget.remove,clipboard.add_text; command=把剪贴板收起来
082. [pass] tools=translate.set_draft; command=把翻译收起来
083. [pass] tools=calculator.set_display; command=把计算器收起来
084. [pass] tools=widget.remove,market.set_indices; command=把行情收起来
085. [pass] tools=widget.remove,headline.request_refresh; command=把新闻收起来
086. [pass] tools=widget.remove,worldClock.set_zones,dialClock.set_night_mode; command=把世界时钟收起来
087. [pass] tools=widget.focus; command=切到音乐窗口
088. [pass] tools=widget.focus,tv.select_channel; command=切到电视窗口
089. [pass] tools=widget.focus,recorder.start; command=切到录音机窗口
090. [pass] tools=widget.focus,weather.set_city; command=切到天气窗口
091. [pass] tools=widget.focus,todo.add_item; command=切到待办窗口
092. [pass] tools=widget.focus; command=切到留言板窗口
093. [pass] tools=widget.focus,dialClock.set_night_mode; command=切到表盘时钟窗口
094. [pass] tools=widget.focus,note.write; command=切到便签窗口
095. [pass] tools=board.add_widget; command=再打开一个音乐
096. [pass] tools=board.add_widget,tv.play; command=再打开一个电视
097. [pass] tools=board.add_widget,weather.set_city; command=再打开一个天气
098. [pass] tools=board.add_widget,countdown.set; command=再打开一个倒计时
099. [pass] tools=board.add_widget,todo.add_item; command=再打开一个待办
100. [pass] tools=board.add_widget,clipboard.add_text; command=再打开一个剪贴板
101. [pass] tools=board.add_widget,translate.set_draft; command=再打开一个翻译
102. [pass] tools=board.add_widget,calculator.set_display; command=再打开一个计算器
103. [pass] tools=board.add_widget,market.set_indices; command=再打开一个行情
104. [pass] tools=board.add_widget,headline.request_refresh; command=再打开一个新闻
105. [pass] tools=board.add_widget,worldClock.set_zones,dialClock.set_night_mode; command=再打开一个世界时钟
106. [pass] tools=board.add_widget,recorder.start; command=再打开一个录音机
...
248. [pass] tools=widget.remove,board.add_widget,countdown.set; command=再打开一个倒计时，用完后把旧的倒计时关闭
...
263. [pass] tools=music.play; command=搜索周杰伦晴天，然后播放第一个完整结果
264. [pass] tools=music.play; command=来一首孙燕姿遇见，如果没找到就先展示搜索结果
...
268. [pass] tools=music.play; command=给我放五月天倔强，播放后把歌词搜索也打开
269. [pass] tools=music.play; command=播放 Beyond 海阔天空，不要换成同名翻唱
270. [pass] tools=music.pause,music.play; command=搜蔡健雅红色高跟鞋，先暂停当前歌曲再播放
...
273. [pass] tools=music.play; command=来一首 Adele 的 Hello，搜索词就用 Adele Hello
...
279. [pass] tools=music.play; command=我要听王菲容易受伤的女人，按歌曲名搜索
280. [pass] tools=music.previous,music.search; command=播放轻松音乐时重新搜索，不要沿用上一首
281. [pass] tools=music.search,translate.set_draft; command=我想听点轻松的中文歌，先搜索不要立刻播放
...
286. [pass] tools=countdown.set,todo.add_item; command=播放舒缓钢琴，三分钟后提醒我休息眼睛
...
290. [pass] tools=music.next,music.play; command=给我找运动时听的歌，并把下一首按钮准备好
291. [pass] tools=music.resume,music.play; command=换成轻松一点的，不要继续现在的歌曲
292. [pass] tools=music.play; command=搜索雨天适合听的音乐，只要歌曲不要电台
293. [pass] tools=music.pause,music.play,tv.pause,tv.play; command=找午休背景音乐，播放前把电视暂停
294. [pass] tools=music.previous,music.search; command=我说的是轻松音乐，不是上一首，重新搜索
295. [pass] tools=music.play,translate.set_draft; command=给我一首安静的英文歌，先搜完整曲库
296. [pass] tools=music.play; command=播放适合开车的歌，但音量不要改
297. [pass] tools=board.add_widget,tv.play; command=搜白噪音或自然声，不要打开电视
298. [pass] tools=music.play; command=来点周末感觉的歌，如果没把握就让我确认
299. [pass] tools=music.pause,music.play; command=先暂停当前歌曲，再找轻柔民谣
300. [pass] tools=music.play,countdown.set; command=把音乐换成专注模式用的播放列表
301. [pass] tools=board.add_widget,tv.fullscreen,tv.select_channel; command=打开电视并切到 CCTV5，完成后全屏
302. [pass] tools=tv.play,headline.request_refresh; command=播放 CCTV13 新闻频道，然后刷新重大新闻
303. [pass] tools=widget.remove,tv.select_channel; command=电视切到电影频道，但不要关闭音乐
304. [pass] tools=music.pause,music.play,tv.pause,tv.play; command=暂停电视直播，继续播放音乐
305. [pass] tools=tv.select_channel; command=把电视从全屏退出来，再切到 CCTV1
306. [pass] tools=board.add_widget,tv.play; command=我想看体育频道，先打开电视再选 CCTV5
307. [pass] tools=app.sidebar.set,widget.fullscreen_focus,tv.fullscreen; command=电视全屏后把侧边栏隐藏
308. [pass] tools=widget.move,board.add_widget,tv.play; command=打开 CCTV6，同时把电视窗口放到右上角
309. [pass] tools=tv.pause,recorder.pause; command=把电视音频先暂停，然后开始录音
310. [pass] tools=widget.remove,tv.select_channel; command=切到 CCTV13，如果失败就保留频道选择界面
311. [pass] tools=board.add_widget,tv.play,weather.set_city; command=打开电视，但不要遮住天气卡片
...
314. [pass] tools=widget.bring_to_front,widget.resize; command=把电视窗口调大一点并置顶
315. [pass] tools=widget.remove,music.play,tv.play; command=关闭电视，同时把音乐继续播放
316. [pass] tools=board.add_widget,tv.play; command=打开电视后不要自动全屏，先让我确认频道
317. [pass] tools=tv.pause,countdown.pause,todo.add_item; command=把当前电视直播暂停五分钟后提醒我回来
318. [pass] tools=note.write; command=切换到电影频道并记录到便签
319. [pass] tools=tv.select_channel; command=电视卡住了，重新选择 CCTV1 并播放
320. [pass] tools=board.add_widget,tv.play; command=打开电视小工具，如果没有就新增一个
...
323. [pass] tools=weather.set_city,todo.add_item,calculator.set_display; command=明早去杭州，帮我看天气并加一条待办
...
327. [pass] tools=widget.bring_to_front,widget.focus,board.add_widget,weather.set_city,headline.request_refresh; command=成都天气卡片放最前，别打开新闻
328. [pass] tools=weather.set_city,converter.set; command=波士顿现在冷不冷，再换算华氏和摄氏
329. [pass] tools=weather.set_city; command=北京和上海天气都打开，我要对比
330. [pass] tools=weather.set_city,todo.add_item; command=我明天出门，先查杭州天气再设早上八点提醒
331. [pass] tools=board.add_widget,weather.set_city,worldClock.set_zones,dialClock.set_night_mode; command=查东京天气，同时打开东京世界时钟
332. [pass] tools=weather.set_city,worldClock.set_zones; command=给我看巴黎天气，顺便显示巴黎时间
333. [pass] tools=board.add_widget,weather.set_city,headline.request_refresh; command=查深圳天气，不要误打开重大新闻
334. [pass] tools=weather.set_city; command=外面适合带伞吗，默认看北京
335. [pass] tools=widget.focus,weather.set_city,worldClock.set_zones; command=帮我把天气城市改成纽约并聚焦天气卡片
336. [pass] tools=weather.set_city; command=查广州天气后把结果发到留言板
337. [pass] tools=board.add_widget,weather.set_city,countdown.set; command=切换天气到成都，同时打开倒计时十五分钟
...
341. [pass] tools=board.add_widget,worldClock.set_zones,dialClock.set_night_mode; command=显示北京伦敦纽约时间，并打开表盘时钟
342. [pass] tools=calculator.set_display,worldClock.set_zones,dialClock.set_night_mode; command=世界时钟加东京和巴黎，然后切到夜间模式
343. [pass] tools=music.play,countdown.set; command=设二十五分钟专注倒计时，同时播放轻音乐
...
346. [pass] tools=widget.resize,dialClock.set_night_mode; command=把表盘时钟调成夜间模式，并缩小一点
347. [pass] tools=widget.remove,worldClock.set_zones,dialClock.set_night_mode; command=关闭时钟夜间模式，再显示纽约时间
348. [pass] tools=countdown.set,todo.add_item; command=半小时后提醒我检查部署日志
349. [pass] tools=countdown.set; command=设置一分三十秒倒计时，名称叫泡茶
350. [pass] tools=countdown.reset; command=把倒计时重置，然后重新设五分钟
351. [pass] tools=weather.set_city,worldClock.set_zones; command=显示东京现在几点，同时查东京天气
352. [pass] tools=todo.add_item; command=明早九点提醒我给客户回电话
353. [pass] tools=board.add_widget,countdown.set,todo.add_item; command=二十分钟后让我休息，不要打开待办列表
354. [pass] tools=widget.remove,worldClock.set_zones,dialClock.set_night_mode; command=世界时钟只保留北京和旧金山
355. [pass] tools=widget.move,dialClock.set_night_mode; command=表盘时钟放到桌面中央，别挡住电视
356. [pass] tools=countdown.set,recorder.start; command=设一个四十五分钟会议倒计时并开始录音
357. [pass] tools=music.pause,countdown.pause; command=暂停计时器，同时把音乐也暂停
358. [pass] tools=widget.bring_to_front,widget.focus,countdown.resume,todo.add_item; command=倒计时恢复后把待办窗口放最前
359. [pass] tools=board.add_widget,worldClock.set_zones,dialClock.set_night_mode; command=打开表盘而不是世界时钟
360. [pass] tools=board.add_widget,dialClock.set_night_mode; command=我说打开时钟时优先打开表盘时钟
361. [pass] tools=music.play,note.write; command=便签记下今天要验证音乐登录和播放完整歌曲
362. [pass] tools=music.play,note.write,calculator.set_display; command=把刚才搜索到的王菲红豆追加到便签
363. [pass] tools=todo.add_item,calculator.set_display; command=添加待办：修复 realtime 工具暴露策略
364. [pass] tools=todo.add_item; command=明天下午三点提醒我检查 Vercel 日志
365. [pass] tools=todo.complete_item; command=把买牛奶标记完成，再新增买咖啡豆
366. [pass] tools=widget.remove,note.clear,calculator.set_display; command=清空便签前先弹确认，不要直接删除
367. [pass] tools=note.write,calculator.set_display,recorder.start; command=把会议纪要追加到便签并开始录音
368. [pass] tools=todo.add_item,calculator.set_display; command=添加待办订酒店，备注写靠近会场
369. [pass] tools=todo.add_item; command=把复盘语音测试设为今天晚上九点提醒
370. [pass] tools=music.search,note.write; command=便签写下：轻松音乐要重新搜索
371. [pass] tools=todo.add_item,calculator.set_display; command=给待办加一条关闭留言板不能发送关闭两个字
372. [pass] tools=todo.complete_item; command=把部署完成这项待办勾掉
373. [pass] tools=countdown.set,todo.add_item; command=五分钟后提醒我看倒计时有没有声音
374. [pass] tools=board.add_widget,note.write,translate.set_draft; command=便签新增一段英文 hello realtime，再打开翻译
375. [pass] tools=note.write; command=把桌面问题列表写入便签，编号从一开始
376. [pass] tools=todo.add_item,calculator.set_display; command=添加待办：测试多轮语音不要重复回复
377. [pass] tools=note.write,calculator.set_display,headline.request_refresh; command=把今天的新闻摘要追加到便签
378. [pass] tools=todo.add_item,clipboard.add_text,calculator.set_display; command=待办里添加查看 Apple Music token
379. [pass] tools=todo.complete_item; command=清理已完成待办前先让我确认
380. [pass] tools=music.play,weather.set_city,note.write; command=便签保存当前播放歌曲和天气城市
...
383. [pass] tools=widget.remove,clipboard.clear; command=清理普通剪贴板记录，保留固定内容
384. [pass] tools=clipboard.add_text; command=把项目口令 demo-token 固定保存到剪贴板
385. [pass] tools=clipboard.add_text,calculator.set_display; command=剪贴板添加一条 WiFi 密码提示但不要读出来
386. [pass] tools=clipboard.add_text; command=把刚才的搜索关键词复制到剪贴板
387. [pass] tools=clipboard.clear; command=清空剪贴板前先确认一次
388. [pass] tools=note.write,clipboard.add_text; command=把会议链接存到剪贴板，并写入便签
...
392. [pass] tools=widget.remove,countdown.set,todo.add_item,clipboard.clear,calculator.set_display; command=把 1234 临时验证码存起来，十分钟后提醒删除
393. [pass] tools=clipboard.add_text; command=把当前歌曲名复制到剪贴板
394. [pass] tools=clipboard.clear; command=清理剪贴板里未固定的测试记录
395. [pass] tools=note.write,clipboard.add_text,translate.set_draft; command=把翻译结果复制到剪贴板，但不要覆盖便签
396. [pass] tools=board.add_widget,clipboard.add_text,dialClock.set_night_mode; command=保存命令：打开表盘时钟 到剪贴板
397. [pass] tools=note.write,clipboard.add_text; command=复制今天日期到剪贴板并打开便签
...
401. [pass] tools=clipboard.add_text,translate.set_draft; command=把 hello world 翻译成中文，然后复制结果
402. [pass] tools=weather.set_city,translate.set_draft; command=把今天适合出门吗翻译成英文
403. [pass] tools=note.write,calculator.set_display; command=计算十二乘十二，再把结果写进便签
...
407. [pass] tools=clipboard.add_text,calculator.set_display; command=计算 199 加 299，然后添加到剪贴板
...
415. [pass] tools=music.play,translate.set_draft; command=把播放轻松音乐翻译成英文
416. [pass] tools=calculator.set_display; command=计算 1024 除以 8，并显示在计算器
417. [pass] tools=note.write,converter.set; command=把十二米换成公里再写到便签
418. [pass] tools=translate.set_draft; command=翻译一段：the music is still preview mode
419. [pass] tools=translate.set_draft; command=把 0.9 以下交给 realtime 翻译成英文备忘
...
422. [pass] tools=headline.request_refresh,market.set_indices; command=看纳指和道指，顺便刷新财经新闻
423. [pass] tools=board.add_widget,market.set_indices; command=打开恒生和上证行情，不要自动开全球指数
424. [pass] tools=note.write,calculator.set_display,headline.request_refresh; command=今天有什么头条新闻，结果追加到便签
425. [pass] tools=worldClock.set_zones,market.set_indices; command=看美股三大指数，同时显示纽约时间
426. [pass] tools=board.add_widget,headline.request_refresh,market.set_indices; command=只刷新新闻，不要打开行情窗口
427. [pass] tools=widget.move,headline.request_refresh,market.set_indices; command=把新闻窗口放到右侧，行情放到左侧
428. [pass] tools=widget.bring_to_front,market.set_indices; command=查询上证指数后把市场窗口置顶
429. [pass] tools=board.switch,board.add_widget,headline.request_refresh; command=打开财经观察桌板并刷新重大新闻
...
432. [pass] tools=widget.remove,market.set_indices; command=全球指数不要刷新，先关闭那个小工具
433. [pass] tools=board.add_widget,tv.play,headline.request_refresh; command=打开重大新闻但不要播放电视
...
436. [pass] tools=countdown.set,todo.add_item,headline.request_refresh; command=刷新头条后提醒我十五分钟后再看
437. [pass] tools=board.add_widget,market.set_indices; command=打开上证和深证行情，别误开音乐
438. [pass] tools=widget.remove,market.set_indices; command=只显示美股指数，关闭港股窗口
439. [pass] tools=note.write,headline.request_refresh; command=新闻刷新失败就记录到便签
440. [pass] tools=widget.focus,board.add_widget,headline.request_refresh; command=打开重大新闻小工具后马上聚焦它
441. [pass] tools=note.write,recorder.start; command=开始录音，并在便签写下会议开始
442. [pass] tools=recorder.stop; command=停止录音后播放刚才录音检查声音
443. [pass] tools=tv.pause,recorder.pause; command=暂停录音回放，同时把电视也暂停
444. [pass] tools=countdown.pause,todo.add_item,recorder.stop; command=开始录一段测试音频，十秒后提醒我停止
445. [pass] tools=board.add_widget,recorder.start; command=打开录音机但先不要开始录
446. [pass] tools=board.add_widget,countdown.set,note.write,recorder.start; command=会议开始，打开录音机、便签和倒计时
447. [pass] tools=recorder.stop; command=停止录音并把文件状态写到留言板
...
450. [pass] tools=dialClock.set_night_mode,recorder.start; command=开始录音后把表盘时钟调成夜间模式
451. [pass] tools=music.pause,music.resume,music.play,recorder.pause; command=暂停录音播放，再继续音乐
452. [pass] tools=recorder.start; command=帮我录一段语音命令复现过程
453. [pass] tools=board.add_widget,clipboard.add_text,recorder.stop; command=停止录音并打开剪贴板保存测试编号
454. [pass] tools=widget.remove,recorder.start; command=录音之前先关闭电视声音
455. [pass] tools=countdown.set,recorder.start; command=开始录音，然后三分钟倒计时
456. [pass] tools=music.pause,music.play,recorder.pause; command=播放录音时把音乐暂停
457. [pass] tools=widget.move,board.add_widget,recorder.start; command=打开录音机，窗口放到左上角
458. [pass] tools=recorder.stop; command=如果录音还在进行就先停止再播放
459. [pass] tools=note.write,calculator.set_display,recorder.stop; command=会议结束，停止录音并追加纪要到便签
460. [pass] tools=widget.focus,todo.add_item,recorder.pause; command=录音回放暂停后聚焦待办窗口
...
464. [pass] tools=widget.remove,board.add_widget,messageBoard.send; command=打开留言板并发送收到，不要关闭窗口
465. [pass] tools=messageBoard.send; command=留言板回复：部署完成后再测一次
466. [pass] tools=messageBoard.send; command=我说关闭留言板时执行关闭，不是发送消息
467. [pass] tools=weather.set_city,headline.request_refresh; command=把天气摘要发到留言板
468. [pass] tools=music.search,messageBoard.send; command=留言板发一句：音乐已经重新搜索
469. [pass] tools=messageBoard.send; command=先清空输入框，再发送测试通过
470. [pass] tools=widget.remove,board.add_widget,todo.add_item; command=关闭留言板后打开待办
471. [pass] tools=messageBoard.send; command=留言板不要重复发送刚才那句话
472. [pass] tools=translate.set_draft,messageBoard.send; command=发送一条包含英文 realtime ready 的留言
473. [pass] tools=widget.move,messageBoard.send; command=把留言板移到底部，然后发送正在测试
474. [pass] tools=messageBoard.send; command=如果留言板没打开，先打开再发收到
475. [pass] tools=widget.bring_to_front; command=不要发消息，只把留言板窗口置顶
476. [pass] tools=countdown.set,messageBoard.send; command=留言板发送：十分钟后回来
477. [pass] tools=widget.remove,headline.request_refresh; command=关闭留言板和新闻窗口
...
482. [pass] tools=board.add_widget,music.pause,tv.pause,tv.play,headline.request_refresh; command=打开电视 CCTV13，再刷新新闻，最后暂停音乐
483. [pass] tools=weather.set_city,todo.add_item,calculator.set_display; command=查北京天气，如果适合出门就加待办买咖啡
484. [pass] tools=board.add_widget,worldClock.set_zones,headline.request_refresh,market.set_indices; command=打开市场行情、重大新闻和纽约时间，排成一列
485. [pass] tools=countdown.set,note.write,recorder.start; command=开始录音，设四十五分钟倒计时，并打开会议便签
486. [pass] tools=board.add_widget,music.search,todo.add_item; command=搜索轻松音乐但先不播放，然后打开待办
487. [pass] tools=clipboard.add_text,translate.set_draft; command=把 hello world 翻译成中文，再复制到剪贴板
488. [pass] tools=board.create,board.add_widget,weather.set_city,worldClock.set_zones; command=新建旅行桌板，打开杭州天气和东京时间
489. [pass] tools=widget.remove,widget.bring_to_front,widget.focus; command=关闭留言板，再把音乐播放器放最前
490. [pass] tools=music.play,countdown.set,todo.add_item; command=播放王菲红豆后，三分钟后提醒我检查是否试听
491. [pass] tools=app.sidebar.set,board.add_widget,worldClock.set_zones,dialClock.set_night_mode; command=打开表盘时钟而不是世界时钟，然后隐藏侧栏
492. [pass] tools=tv.select_channel,headline.request_refresh; command=把电视切到 CCTV5，再把体育新闻刷新一下
493. [pass] tools=clipboard.clear; command=清理剪贴板普通记录，再把项目口令固定
494. [pass] tools=todo.add_item,calculator.set_display; command=添加待办提交报告，同时明早九点提醒
495. [pass] tools=converter.set,calculator.set_display; command=计算两公斤是多少克，把结果发到留言板
496. [pass] tools=weather.set_city,worldClock.set_zones,dialClock.set_night_mode; command=天气改成武汉，世界时钟改成北京伦敦纽约
497. [pass] tools=board.add_widget,music.pause,countdown.pause,recorder.pause; command=把音乐暂停，开始录音，然后打开倒计时
498. [pass] tools=board.create,board.add_widget,note.write,translate.set_draft,calculator.set_display; command=新建学习桌板并打开翻译、计算器、便签
499. [pass] tools=note.write,clipboard.add_text,calculator.set_display,headline.request_refresh; command=刷新新闻后把摘要追加到便签并复制
500. [pass] tools=app.sidebar.set,app.fullscreen.set,board.auto_align; command=退出全屏，显示侧边栏，再整理桌面
501. [pass] tools=board.add_widget,worldClock.set_zones,dialClock.set_night_mode; command=打开时钟，啊不是世界时钟，是那个表盘时钟
502. [pass] tools=music.play; command=播放十年，不对，是陈奕迅的十年
503. [pass] tools=widget.remove; command=关闭留言，准确说关闭留言板窗口
504. [pass] tools=music.previous,music.search; command=我想听轻松音乐，别继续上一首，重新搜
505. [pass] tools=board.add_widget,weather.set_city; command=打开天气，城市先用北京，刚才说错了不是上海
506. [pass] tools=widget.fullscreen_focus,tv.fullscreen; command=把电视全屏，等下先别全屏，先切 CCTV5
507. [pass] tools=todo.add_item,calculator.set_display; command=添加待办买票，哦再加一条订酒店
508. [pass] tools=translate.set_draft; command=翻译 close message board，只翻译不要执行
509. [pass] tools=music.play; command=搜索王菲红豆，如果识别成王飞请改成王菲
510. [pass] tools=board.add_widget,dialClock.set_night_mode; command=打开表盘时钟，别打开全球时钟列表
511. [pass] tools=widget.remove; command=我刚说关闭，其实是关闭留言板
512. [pass] tools=music.previous,music.search; command=音乐上一首不是我要的，重新搜周杰伦晴天
...
516. [pass] tools=board.add_widget,headline.request_refresh,market.set_indices; command=新闻别打开全球指数，只要重大新闻
517. [pass] tools=widget.resize,widget.focus,calculator.set_display; command=把计算器放大，算了先聚焦就行
...
525. [pass] tools=widget.remove,countdown.set,calculator.set_display; command=删除临时倒计时，保留正在运行的那个
526. [pass] tools=todo.complete_item; command=清空待办已完成项，需要弹确认
527. [pass] tools=widget.remove,headline.request_refresh,market.set_indices; command=关闭全部新闻和行情窗口，确认后执行
528. [pass] tools=widget.remove,calculator.set_display; command=把留言板收起来但不要删除历史消息
529. [pass] tools=countdown.reset; command=重置倒计时前先告诉我当前状态
530. [pass] tools=music.play; command=清空搜索结果不要影响播放中的歌曲
531. [pass] tools=widget.remove; command=关闭所有临时小工具，保留桌板
532. [pass] tools=note.clear; command=把便签清空并写新内容，先确认清空
533. [pass] tools=widget.remove,clipboard.clear; command=清理剪贴板时保留 pinned 内容
534. [pass] tools=assistant.reply; command=撤销刚才的关闭动作，如果不能撤销就提示
535. [pass] tools=board.auto_align; command=自动整理桌面后不要改变全屏状态
536. [pass] tools=widget.remove,tv.select_channel,calculator.set_display; command=关闭电视直播，但不要清除频道选择
537. [pass] tools=recorder.stop; command=停止录音前确认当前是否正在录
538. [pass] tools=calculator.set_display; command=删除临时桌板之前先让我确认
539. [pass] tools=calculator.set_display,messageBoard.send; command=清除留言板输入框，不要发送空消息
540. [pass] tools=widget.remove; command=关闭全部媒体小工具前先弹统一确认
541. [pass] tools=dialClock.set_night_mode; command=把表盘时钟调暗一点，进入夜间模式
542. [pass] tools=widget.resize,widget.fullscreen_focus,music.play; command=音乐封面太小了，把播放器面板放大
543. [pass] tools=widget.move,widget.resize; command=电视窗口太挡眼，缩小并放到右上角
544. [pass] tools=app.sidebar.set; command=隐藏侧栏让桌面更宽，但保留所有小工具
545. [pass] tools=music.play; command=把音乐播放控件居中，登录按钮别挡封面
546. [pass] tools=countdown.pause; command=倒计时声音太像计时器，先暂停倒计时
547. [pass] tools=widget.resize,weather.set_city; command=把天气卡片放大一点方便读温度
548. [pass] tools=widget.resize,note.write,headline.request_refresh; command=把新闻窗口缩小，避免挡住便签
549. [pass] tools=widget.resize; command=音乐窗口不要全屏，只把封面放大
550. [pass] tools=widget.move,dialClock.set_night_mode; command=把表盘放到中间并打开夜间模式
551. [pass] tools=app.sidebar.set,widget.fullscreen_focus,tv.fullscreen; command=电视全屏时隐藏侧边栏
552. [pass] tools=widget.resize,worldClock.set_zones,dialClock.set_night_mode; command=把世界时钟文字放大，显示北京伦敦纽约
553. [pass] tools=widget.resize,todo.add_item; command=让待办窗口宽一点，长文本不要折断
554. [pass] tools=widget.move,clipboard.add_text; command=把剪贴板窗口移到右侧并缩窄
555. [pass] tools=app.sidebar.set; command=显示侧边栏，但不要压缩音乐封面
556. [pass] tools=app.fullscreen.set,music.play; command=退出全屏后把音乐播放器恢复正常大小
557. [pass] tools=widget.bring_to_front,countdown.set,recorder.start; command=让录音机窗口别盖住倒计时
558. [pass] tools=widget.resize,translate.set_draft; command=把翻译窗口调宽，方便输入长英文
559. [pass] tools=board.auto_align; command=把桌面布局排紧凑一点
560. [pass] tools=widget.move; command=音乐登录按钮放右上角但不要覆盖封面
561. [pass] tools=board.create,board.add_widget,weather.set_city,note.write,todo.add_item; command=新建今日计划桌板，打开待办、便签和天气
562. [pass] tools=note.write; command=写下今天三件事：部署、测试、复盘
563. [pass] tools=music.play,countdown.set; command=设二十五分钟专注倒计时并播放轻音乐
564. [pass] tools=todo.add_item,calculator.set_display,recorder.start; command=把九点开会添加到待办并开始录音准备
565. [pass] tools=note.write,headline.request_refresh; command=刷新新闻后只把重要事项写到便签
566. [pass] tools=todo.add_item,calculator.set_display; command=把复盘 realtime 断线问题加入待办
...
572. [pass] tools=note.write,todo.complete_item,calculator.set_display; command=把会议纪要追加到便签，然后标记待办完成
573. [pass] tools=todo.add_item; command=新建一条待办：验证语音打开小工具
574. [pass] tools=recorder.start; command=开始录音记录今天的问题列表
575. [pass] tools=widget.remove,countdown.set; command=关闭电视，保留音乐和倒计时
576. [pass] tools=widget.move,board.add_widget,music.play; command=打开工作台并把音乐播放器放到最前
577. [pass] tools=todo.add_item; command=明早八点提醒我继续回归测试
578. [pass] tools=music.play,note.write; command=把轻松音乐播放失败写入便签
579. [pass] tools=todo.add_item,calculator.set_display; command=添加待办：检查 Apple Music 是否试听
580. [pass] tools=board.auto_align,widget.focus,todo.add_item; command=整理桌面后聚焦待办窗口
...
583. [pass] tools=music.play; command=播放英语听力背景音乐，先搜索不播放
...
627. [pass] tools=music.play,calculator.set_display; command=搜索王菲红豆时加载音乐搜索和播放工具
...
652. [pass] tools=music.play; command=重新授权音乐账号后再搜索王菲红豆
...
665. [pass] tools=music.play; command=播放音乐失败时记录搜索词、工具名和错误
...
695. [pass] tools=music.play; command=搜索轻松音乐不要复用上一条播放器状态
