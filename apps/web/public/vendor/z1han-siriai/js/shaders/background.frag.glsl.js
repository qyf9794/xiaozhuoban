 ...
 * [OUTPUT]: BACKGROUND_FRAGMENT_SHADER — cover-fit photo background with gradient fallback
 * [POS]: shaders/ 的场景底层；照片未就绪时用暗色渐晕渐变兜底（uBackgroundReady 混合）
 * [PROTOCOL]: 变更时更新此头部，然后检查 AGENTS.md
 */

// ============================================================================
// Background pass. Verbatim GLSL from the original siri27 bundle.
// coverUv implements CSS object-fit:cover in shader space.
// ============================================================================
