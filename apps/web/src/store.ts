...
import { createId, nowIso, type Board, type WidgetDefinition, type WidgetInstance } from "@xiaozhuoban/domain";
...
import { enqueueAssistantCloudMutation } from "./assistant/assistantOutbox";
import { parseBackupSnapshot } from "./store/backup";
import { createRepository, makeBoard, makeWorkspace, persistBoardWithWidgets } from "./store/initialization";
import { persistInBackground } from "./store/persistence";
import { createMissingSystemDefinitions } from "./store/systemWidgets";
import {
  DEFAULT_BOARD_WIDGET_OFFSET,
  MOBILE_STACK_GAP,
  MOBILE_STACK_MARGIN,
  buildDefinitionTypeMap,
  createDefaultBoardWidgets,
  getDefaultWidgetSize,
  getNextDesktopWidgetPosition,
  getNextMobileWidgetPosition,
  measureWidgetLayout,
  normalizeWidgetInstances,
  safeWidgetHeight,
  safeWidgetWidth
} from "./store/widgetLayout";

let initializingPromise: Promise<void> | null = null;

export { createDefaultBoardWidgets, toCanvasContentPosition } from "./store/widgetLayout";
