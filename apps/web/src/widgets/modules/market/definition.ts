...
export const marketCapabilities = ["打开行情", "查询指数", "刷新行情", "关闭窗口"];

export const marketShortcutExamples = ["打开纳斯达克", "纳指给我看一眼", "美股怎么样", "A股行情", "看恒生指数"];
...
export const marketShortcuts: ShortcutRule[] = [
  {
    ...
    actions: ["行情", "指数"],
    examples: ["打开纳斯达克", "纳指给我看一眼", "美股怎么样", "A股行情", "看恒生指数"],
    risk: "safe"
  }
];
